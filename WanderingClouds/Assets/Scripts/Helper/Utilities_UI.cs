...
public static class Utilities_UI
{
    ...
    public static Vector2 GetScreenPosOfGameObject(this Camera cam, Vector3 position) => cam.WorldToScreenPoint(position);
    public static Vector2 GetScreenRatioPosOfGameObject(this Camera cam, Vector3 position) => cam.WorldToScreenPoint(position)/ cam.pixelRect.size;
