...
namespace WanderingCloud.Controller
{
    ...
    public class PlayerBrain : Pawn
    {
        ...
        [field: SerializeField, Foldout("References"), Required()] public CinemachineFreeLook CinemachineExplo { get; private set; }
        ...
        {
            CinemachineExplo.gameObject.SetActive(true);

            var inputLink = CinemachineExplo.GetComponent<CinemachineInputProvider>();
            inputLink.PlayerIndex = playerIndex;
        }
        public override void PlayerDisconnect(int playerIndex)
        {
            CinemachineExplo.gameObject.SetActive(false);
        }
